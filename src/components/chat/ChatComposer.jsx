  ...
  return (
    <div className="flex items-end gap-2 px-4 py-3 bg-white border-t border-gray-200">
      <textarea
        ...
        rows={1}
        className="flex-1 resize-none rounded-xl border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ocean-400 min-h-[44px] max-h-[120px]"
        aria-label="Message input"
      />
      <button
        onClick={send}
        disabled={!text.trim()}
        className="bg-ocean-600 text-white p-2.5 rounded-xl min-h-[44px] min-w-[44px] flex items-center justify-center hover:bg-ocean-700 disabled:opacity-40 transition-colors"
